...
class OutBase(PosDataBase):
    ...
    is_logical_contained : bool
        Whether this object's points' modules agree with the modules they are reconstructed in.
    is_matched: bool
    ...
    is_logical_contained: bool = True #Default to True for backwards compatibility
    ...
    # Boolean attributes
    _bool_attrs = (
            'is_contained', 'is_logical_contained', 'is_matched', 'is_cathode_crosser', 'is_truth'
    )
